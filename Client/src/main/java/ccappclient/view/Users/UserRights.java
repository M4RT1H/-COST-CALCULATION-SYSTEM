...
public class UserRights extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Сменить права пользователя:");

        AdminUserGroup.add(AdminRadio);
        AdminRadio.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        AdminRadio.setSelected(true);
        AdminRadio.setText("Администратор");

        AdminUserGroup.add(UserRadio);
        UserRadio.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        UserRadio.setText("Пользователь");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Boolean check = this.AdminRadio.isSelected();
