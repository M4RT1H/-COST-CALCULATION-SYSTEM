...
public class UserRegForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Регистрация сотрудника");
...
//        ResultSet rs = null;
//        try {
//            rs = stmt.executeQuery("SELECT UserLogin FROM users");
//
//            ArrayList<String[]> resultSets = new ArrayList<>();
//
//            while (rs.next()) {
//                if(rs.getString("UserLogin").equals(this.jTextField3.getText()))
//                {
//                    
//                }
...
//        
        ...
        Client.stringmap.put("EmployeeName", this.jTextField1.getText());
        Client.stringmap.put("EmployeeSurname", this.jTextField2.getText());
        Client.stringmap.put("UserLogin", this.jTextField3.getText());
        Client.stringmap.put("UserPassword", this.jTextField4.getText());
